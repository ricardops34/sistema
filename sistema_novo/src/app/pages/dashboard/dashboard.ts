...
@Component({
    ...
    template: `
        <po-page-default p-title="Painel de Gestao (BI)">
              <div class="po-row">
                      <!-- Widgets de KPI -->
                              <po-widget class="po-md-4 po-mb-1" p-title="Horas no Mes (168)" p-primary>
                                        <div class="po-font-subtitle po-text-center">Meta: 160h</div>
                                                </po-widget>

                                                        <po-widget class="po-md-4 po-mb-1" p-title="Faturamento Bruto (R$ 42.500)" p-primary>
                                                                  <div class="po-font-subtitle po-text-center">Crescimento: +12%</div>
                                                                          </po-widget>

                                                                                  <po-widget class="po-md-4 po-mb-1" p-title="Projetos Ativos (12)" p-primary>
                                                                                                                        ...
                                                                                                                        <!-- Grafico de Produtividade -->
                                                                                                                                <po-chart
                                                                                                                                          class="po-md-8 po-mb-1"
                                                                                                                                                    p-title="Produtividade por Mes (Horas)"
