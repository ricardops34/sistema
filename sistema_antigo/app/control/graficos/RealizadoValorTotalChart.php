...
class RealizadoValorTotalChart extends TPage
{
    private $form; // form
    private $loaded;
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Gráfico de valor total gerado por profissional");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Gráficos","Valor total gerado por profissional"]));
        }
        ...
        try
        {
            ...
            if ($objects)
            {
                ...
                foreach ($objects as $obj)
                {
                    ...
                    $groups[$group1] = true;
                    $numericField = $obj->evaluate('=( {contrato->valor_hora} * {horas}  )');
                ...
                $chart->enableSection('main', [
                    ...
                    'width' => 100,
                    'widthType' => '%',
                    'title' => 'Valor total gerado por profissional',
                    'showLegend' => 'false',
