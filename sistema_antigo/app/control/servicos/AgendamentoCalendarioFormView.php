<?php
/**
 * AgendamentoCalendarioForm Form
 * @author  <your name here>
 */
class AgendamentoCalendarioFormView extends TPage
{
    private $fc;
    ...
    public function __construct($param = null)
    {
        ...
        $this->fc->setDayClickAction(new TAction(array('AgendamentoCalendarioForm', 'onStartEdit')));
        $this->fc->setEventClickAction(new TAction(array('AgendamentoCalendarioForm', 'onEdit')));
        $this->fc->setEventUpdateAction(new TAction(array('AgendamentoCalendarioForm', 'onUpdateEvent')));
