...
class RealizadoList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_Realizado';
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Listagem de trabalhos realizados");
        $this->limit = 20;
        ...
        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null)],[$id],[new TLabel("Contrato:", null, '14px', null)],[$contrato_id]);
        $row2 = $this->form->addFields([new TLabel("Data inicial:", null, '14px', null)],[$inicio],[new TLabel("Data final:", null, '14px', null)],[$fim]);
        ...
        $filterVar = TSession::getValue("userid");
        $this->filter_criteria->add(new TFilter('profissional_id', 'in', "(SELECT id FROM profissional WHERE system_user_id = '{$filterVar}')"));

        $this->datagrid->style = 'width: 100%';
        $this->datagrid->setHeight(250);
        $this->datagrid->enablePopover("", "Obs:  {observacao} 
Descrição:  {descricao} ");

        $column_id = new TDataGridColumn('id', "Id", 'left' , '80px');
        $column_contrato_descricao = new TDataGridColumn('contrato->descricao', "Contrato", 'left');
        $column_profissional_nome = new TDataGridColumn('profissional->nome', "Profissional", 'left');
        $column_inicio_transformed = new TDataGridColumn('inicio', "Início", 'left');
        $column_fim_transformed = new TDataGridColumn('fim', "Fim", 'left');
        $column_horas = new TDataGridColumn('horas', "Horas", 'left');
        $column_id1 = new TDataGridColumn('id', "Nova coluna", 'left');
        ...
        $order_inicio_transformed = new TAction(array($this, 'onReload'));
        $order_inicio_transformed->setParameter('order', 'inicio');
        $column_inicio_transformed->setAction($order_inicio_transformed);
        $order_fim_transformed = new TAction(array($this, 'onReload'));
        $order_fim_transformed->setParameter('order', 'fim');
        $column_fim_transformed->setAction($order_fim_transformed);
        $order_horas = new TAction(array($this, 'onReload'));
        $order_horas->setParameter('order', 'horas');
        $column_horas->setAction($order_horas);

        $this->datagrid->addColumn($column_id);
        $this->datagrid->addColumn($column_contrato_descricao);
        ...
        $this->datagrid->addColumn($column_id1);
        ...
        $action_onDelete = new TDataGridAction(array('RealizadoList', 'onDelete'));
        ...
        $panel = new TPanelGroup("Listagem de trabalhos realizados");
        ...
        $button_xls->setAction(new TAction(['RealizadoList', 'onExportXls']), "XLS");
        $button_xls->addStyleClass('');
        $button_xls->setImage('fas:file-excel #4CAF50');

        $this->datagrid_form->addField($button_xls);

        $button_csv = new TButton('button_button_csv');
        $button_csv->setAction(new TAction(['RealizadoList', 'onExportCsv']), "CSV");
        ...
        $button_cadastrar->setAction(new TAction(['RealizadoForm', 'onShow']), "Cadastrar");
        ...
        $btnShowCurtainFilters->setAction(new TAction(['RealizadoList', 'onShowCurtainFilters']), "Filtros");
        ...
        $button_limpar_filtros->setAction(new TAction(['RealizadoList', 'onClearFilters']), "Limpar filtros");
        $button_limpar_filtros->addStyleClass('');
        $button_limpar_filtros->setImage('fas:eraser #f44336');

        $this->datagrid_form->addField($button_limpar_filtros);

        $dropdown_button_exportar = new TDropDown("Exportar", 'fas:cog #000000');
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Serviços","Trabalhos realizados"]));
        }
    ...
    public static function onShowCurtainFilters($param = null) 
    {
        try 
        {
            ...
            $page->setProperty('page-name', 'RealizadoListSearch');
            $page->setProperty('page_name', 'RealizadoListSearch');
