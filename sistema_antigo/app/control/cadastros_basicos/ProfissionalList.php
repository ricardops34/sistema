...
class ProfissionalList extends TPage
{
    ...
    private static $formName = 'formList_Profissional';
    ...
    public function __construct($param = null)
    {
        ...
        $row2 = $this->form->addFields([new TLabel("Nome:", null, '14px', null)],[$nome],[new TLabel("Usuário do sistema:", null, '14px', null)],[$system_user_id]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['ProfissionalForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $column_id = new TDataGridColumn('id', "Id", 'left' , '140px');
        $column_nome = new TDataGridColumn('nome', "Nome", 'left');
        $column_system_user_name = new TDataGridColumn('system_user->name', "Usuário do sistema", 'left');
        ...
        $action_onEdit = new TDataGridAction(array('ProfissionalForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('ProfissionalList', 'onDelete'));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Profissional
