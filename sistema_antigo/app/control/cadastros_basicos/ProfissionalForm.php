...
class ProfissionalForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $system_user_id->addValidation("Usuário do sistema", new TRequiredValidator()); 
        ...
        $row2 = $this->form->addFields([new TLabel("Nome:", '#ff0000', '14px', null)],[$nome],[new TLabel("Usuário do sistema:", '#ff0000', '14px', null)],[$system_user_id]);
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            **/
            ...
            $messageAction = new TAction(['ProfissionalList', 'onShow']);   
