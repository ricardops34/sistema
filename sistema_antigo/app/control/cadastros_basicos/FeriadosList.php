...
class FeriadosList extends TPage
{
    ...
    private static $formName = 'formList_Feriado';
    ...
    public function __construct($param = null)
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Data:", null, '14px', null, '100%'),$dt_feriado],[new TLabel("Descrição:", null, '14px', null, '100%'),$descricao]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['FeriadosForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $column_dt_feriado_transformed = new TDataGridColumn('dt_feriado', "Data", 'left');
        $column_tipo_transformed = new TDataGridColumn('tipo', "Tipo do Feriado ", 'left');
        $column_descricao = new TDataGridColumn('descricao', "Descrição", 'left');

        $column_dt_feriado_transformed->setTransformer(function($value, $object, $row, $cell = null, $last_row = null)
        {
        ...
        $this->datagrid->addColumn($column_dt_feriado_transformed);
        $this->datagrid->addColumn($column_tipo_transformed);
        $this->datagrid->addColumn($column_descricao);

        $action_onEdit = new TDataGridAction(array('FeriadosForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('FeriadosList', 'onDelete'));
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Cadastros básicos","Feriados"]));
        }
    ...
    public function onSearch($param = null)
    {
        ...
        if (isset($data->dt_feriado) AND ( (is_scalar($data->dt_feriado) AND $data->dt_feriado !== '') OR (is_array($data->dt_feriado) AND (!empty($data->dt_feriado)) )) )
        {

            $filters[] = new TFilter('dt_feriado', '=', $data->dt_feriado);// create the filter 
        }
